  ...
  (let* ((search-term (car a-list))
         ...
         (candidates (-map (lambda (f)
                             (let* ((candidate f)
                               ...
                               (cond
                                ...
                                (t
                                 (unless (string-equal alchemist-company-last-completion candidate)
    ...
    (cond
     ((and (string-match-p "\\.$" search-term)
           ...
           (not (string-equal alchemist-company-last-completion (replace-regexp-in-string "\\.$" "" search-term))))
